...
export type LangCode = keyof typeof langCode2TTSLang

export function getLabelName(shortName: string) {
  const target = langList.find(item => item.ShortName === shortName)
  return target ? target.LocalName : shortName
}
